...
//		}
		...
		if (msg.indexOf("=====")== -1) {
			formattedWithArgs = MessageFormat.format(getResourceMessage(this.traceMessageCatalog, msg), inserts);
		}
		
		if (DEBUG_PUSH) {
			//YLogger.d("MQTT", "logLevel = " + level + " sourceClass = " 
//			+ sourceClass + " sourceMethod =" + sourceMethod + 
//			" msg =" + formattedWithArgs + " ex = " + error);
		}
