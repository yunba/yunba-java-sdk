...
public abstract class MqttWireMessage {
	...
	public String getTypeStr() {
		...
		case MESSAGE_TYPE_DISCONNECT:
			return "MESSAGE_TYPE_DISCONNECT";
			
		case MESSAGE_TYPE_UNSUBACK:
			return "MESSAGE_TYPE_UNSUBACK";
		case MESSAGE_TYPE_UNSUBSCRIBE:
			return "MESSAGE_TYPE_UNSUBSCRIBE";
			
		case MESSAGE_TYPE_EXPAND:
	...
	private static MqttWireMessage createWireMessage(InputStream inputStream) throws MqttException {
		try {
			...
			} else if (type == MqttWireMessage.MESSAGE_TYPE_EXPAND) {
				result = new MqttExpandAck(info, data);
			}
			else {
